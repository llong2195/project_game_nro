...
import Dragon.models.skill.SkillNotFocus;
...
public class SkillUtil {
    ...
    public static boolean isUseSkillDacBiet(Player player) {
        int skillId = player.playerSkill.skillSelect.template.id;
        return (skillId == Skill.SUPER_KAME || skillId == Skill.MA_PHONG_BA || skillId == Skill.LIEN_HOAN_CHUONG || skillId == Skill.SUPER_TRANFORMATION || skillId == Skill.EVOLUTION || skillId == Skill.DICH_CHUYEN_TUC_THOI || skillId == Skill.THAI_DUONG_HA_SAN || skillId == Skill.THOI_MIEN || skillId == Skill.TROI);
    }
...
//        return 10000;
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1724 && tempId <= 1730) {
