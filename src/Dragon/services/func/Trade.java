...
public class Trade {
    ...
    public static final int TIME_TRADE = 2000;
    public static final int QUANLITY_MAX = 5000;
...
//            case 27: //
//                if (item.template.id == 1129 || item.template.id == 921 || item.template.id == 1132) {
//                    return true;
//                } else if (item.template.id != 380) {
//                    return false;
//                }
        ...
        try {
            ...
            if (pl.equals(player1)) {
                ...
                for (Item item : itemsTrade1) {
                    ...
                    if (player2.getSession().version == 15) {//version
                ...
                for (Item item : itemsTrade2) {
                    msg.writer().writeShort(item.template.id);
                    if (player1.getSession().version == 15) {//version
                        msg.writer().writeInt(item.quantity);
                    } else {
                        msg.writer().writeByte(item.quantity);
                    }
