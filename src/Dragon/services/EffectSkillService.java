...
import Dragon.models.player.EffectSkill;
...
public class EffectSkillService {
    ...
    public void sendEffectUseSkill(Player player, byte skillId) {
        ...
        try {
            ...
            Dragon.utils.Logger.logException(EffectSkillService.class, e);
        }
    }
    ...
    // public void SetHoaCarot(Player player, long lastTimeHoaCarot, int
    // timeHoaCarot){
    ...
    public void sendEffectBlindThaiDuongHaSan(Player plUseSkill, List<Player> players, List<Mob> mobs, int timeStun) {
        ...
        try {
            ...
            Dragon.utils.Logger.logException(EffectSkillService.class,
                    e);
    ...
    public void sendEffectStartCharge(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt((int) player.id);
            msg.writer().writeShort((short) 129); // SkillId cố định cho TAI_TAO_NANG_LUONG
            Service.gI().sendMessAllPlayerInMap(player, msg);
            msg.cleanup();
