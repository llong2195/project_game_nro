...
public class NPoint {
    ...
    private void setHpMax() {
        ...
        // Apply pet fusion HP bonus using utility class (replaces 40+ repetitive if statements)
        this.hpMax = PetFusionBonus.applyHpFusionBonus(this.player, this.hpMax);
        // phù
    ...
    private void setMpMax() {
        ...
        // Apply pet fusion MP bonus using utility class (replaces 40+ repetitive if statements)
        this.mpMax = PetFusionBonus.applyMpFusionBonus(this.player, this.mpMax);
        // hợp thể
    ...
    private void setDame() {
        ...
        // Apply pet fusion Damage bonus using utility class (replaces 40+ repetitive if statements)
        this.dame = PetFusionBonus.applyDamageFusionBonus(this.player, this.dame);
        // thức ăn
