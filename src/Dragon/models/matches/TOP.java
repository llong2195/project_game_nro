...
public class TOP {
    ...
    public static class Builder {
        ...
        public Builder name(String v) { inst.setName(v); return this; }
        public Builder gender(byte v) { inst.setGender(v); return this; }
        public Builder head(short v) { inst.setHead(v); return this; }
        public Builder body(short v) { inst.setBody(v); return this; }
        public Builder leg(short v) { inst.setLeg(v); return this; }
        public Builder power(long v) { inst.setPower(v); return this; }
        public Builder ki(long v) { inst.setKi(v); return this; }
        public Builder hp(long v) { inst.setHp(v); return this; }
        public Builder sd(long v) { inst.setSd(v); return this; }
        public Builder nv(byte v) { inst.setNv(v); return this; }
        public Builder subnv(byte v) { inst.setSubnv(v); return this; }
        public Builder sk(int v) { inst.setSk(v); return this; }
        public Builder pvp(int v) { inst.setPvp(v); return this; }
        public Builder id_player(int v) { inst.setId_player(v); return this; }
        public Builder info1(String v) { inst.setInfo1(v); return this; }
        public Builder info2(String v) { inst.setInfo2(v); return this; }
        public TOP build() { return inst; }
    }
