...
public class phuocboss4 extends Boss {

    public phuocboss4() throws Exception {
        super(BossID.PHUOCBOSS4, BossesData.PHUOCBOSS4);
    }
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(5, 100)) {
            if (Util.isTrue(1, 20)) {
                Service.gI().dropItemMap(this.zone, new ItemMap(zone, 1746, 2, this.location.x, this.location.y, plKill.id));
            }
        } else {
