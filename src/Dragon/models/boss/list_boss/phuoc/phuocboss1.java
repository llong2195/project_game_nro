...
public class phuocboss1 extends Boss {

    public phuocboss1() throws Exception {
        super(BossID.PHUOCBOSS1, BossesData.PHUOCBOSS1);
    }
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(5, 100)) {
            if (Util.isTrue(1, 20)) {
                Service.gI().dropItemMap(this.zone, new ItemMap(zone, 1738, 2, this.location.x, this.location.y, plKill.id));
            }
        } else {
