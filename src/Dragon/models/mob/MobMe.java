...
public final class MobMe extends Mob {
        ...
        try {
            if (pl != null) {
                if (pl.nPoint.hp > this.point.dame && pl.nPoint.hp > pl.nPoint.hpMax * 0.05) {
                    ...
                    msg.writeDouble(Dragon.utils.Util.limitDouble(pl.nPoint.hp));
            ...
            if (mob != null) {
                if (mob.point.gethp() > this.point.dame) {
                    ...
                    msg.writer().writeDouble(Dragon.utils.Util.limitDouble(mob.point.gethp()));
                    msg.writer().writeDouble(Dragon.utils.Util.limitDouble(this.point.dame));
                    Service.gI().sendMessAllPlayerInMap(this.zone, msg);
                    msg.cleanup();
    ...
    public void spawn() {
        ...
        try {
            ...
            msg.writer().writeDouble(Dragon.utils.Util.limitDouble(this.point.hp));// hp mob
            Service.gI().sendMessAllPlayerInMap(this.zone, msg);
            msg.cleanup();
        } catch (Exception e) {
