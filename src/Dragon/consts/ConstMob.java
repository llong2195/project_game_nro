...
public class ConstMob {
    ...
    public static final byte DOI_QUY = 102;
    public static final byte DI_NHAN = 103;
    public static final byte CHIEN_BINH_CA_XANH = 104;
    public static final byte CHIEN_BINH_CA_TIM = 105;
    public static final byte THAY_MA = 106;
    public static final byte SOI = 107;
    public static final byte RET_DOC = 108;
    public static final byte DAU_MA = 109;
    public static final byte HINH_NHAN = 110;
    public static final byte HINH_NHAN_QUY = 111;
